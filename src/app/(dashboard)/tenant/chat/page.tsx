...
export default function TenantChatPage() {
    return (
        <div className="max-w-4xl mx-auto py-12 px-4 text-center space-y-4">
            ...
            <p className="text-xs font-medium text-stone-slate max-w-sm mx-auto">Active communication channels populate automatically once inspection tours are booked.</p>
        </div>
    )
}
